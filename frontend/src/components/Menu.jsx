...
import { FiHome, FiFileText, FiUsers, FiLogOut, FiBarChart2 } from 'react-icons/fi'
...
const Menu = () => {
  ...
  return (
    <Navbar collapseOnSelect bg="dark" variant="dark" expand="lg" className="mb-4 animate__animated animate__fadeInDown animate__slower">
      <Container>
