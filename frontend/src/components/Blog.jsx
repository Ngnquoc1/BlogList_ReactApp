...
import { Container, Card, Button, Badge, ListGroup, Form, InputGroup, Alert } from 'react-bootstrap'
import { FiHeart, FiTrash2, FiExternalLink, FiUser, FiMessageSquare, FiEdit } from 'react-icons/fi'
...
const Blog = ({ blog }) => {
  ...
  if (!blog) {
    return <Container className="mt-4"><p>Blog not found</p></Container>
  }
        ...
        <Card.Body>
          ...
          {isOwner && (
            <div className="d-flex gap-2">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button variant="warning" size="sm" onClick={() => setShowEditModal(true)}>
