  ...
  return (
    <Container className="mt-4">
      ...
      <SearchBar 
        ...
        placeholder="Search by title, author, or URL..."
      />
      <ListGroup as={motion.div} variants={containerVariants} initial="hidden" animate="visible">
        {blogs.map((blog, index) => (
          ...
          >
            <motion.div variants={itemVariants} style={{ width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
